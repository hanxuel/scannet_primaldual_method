...
"""
#new dataset
#niter 50 every 10 share same weights; iterstep as variables
import os
import glob
import argparse
import numpy as np
...
def train_model(data_path,val_path, model_path, params):
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        train_saver.restore(sess, os.path.join(checkpoint_path, "checkpoint-00000013"))
        print("checkpoint-00000013 has been restored")
